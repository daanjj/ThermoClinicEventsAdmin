...
3. Alle deelnemers die voor deze gearchiveerde clinics stonden ingeschreven, worden uit de Open Form Responses en Besloten Form Responses sheets verwijderd.  
   Dit zorgt ervoor dat de operationele sheets schoon en relevant blijven.
...
## 4.4	Communicatie met Deelnemers (Mail Merge)
...
### 4.4.3	Naamgeving voor Sjablonen met Bijlagen
...
### 4.4.4	Beschikbare Placeholders
...
### 4.4.5	Speciale Placeholders (Tijdrekenen)
...
## 4.5	Importeren van Deelnemers via Excel
...
### 4.5.2	Vereisten voor het Excel-bestand
...
### 4.5.3	Verwerking van Bestaande Deelnemers
